 ...
 *{box-sizing:border-box}
 ...
 body{display:flex;align-items:center;justify-content:flex-start;padding-left:4mm!important}
 .ticket-label{width:81.5mm;height:26.4mm;padding:.9mm 1.2mm;overflow:hidden;border:1px solid #000;border-radius:1.7mm;display:grid;grid-template-rows:5.4mm 6.5mm 8.4mm 3.1mm}
 .top{display:grid;grid-template-columns:29mm 1fr;gap:1.6mm;border-bottom:.8px solid #000;padding-bottom:.45mm}
 .brand{display:flex;flex-direction:column;justify-content:center;line-height:.84;overflow:hidden;padding-left:1.2mm}
 ...
 .details{display:grid;grid-template-columns:28mm 1fr;border-bottom:.8px solid #000;min-height:0}
 .customer{padding:.7mm 1.1mm 0 1.8mm;border-right:.8px solid #000;min-width:0;overflow:hidden}
 ...
 .footer{display:grid;grid-template-columns:1fr 1fr 1fr;font-size:5.4px;font-weight:700;min-height:0}.footer div{padding:.58mm .8mm 0;border-right:.8px solid #000;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.footer div:first-child{padding-left:1.8mm}.footer div:last-child{border-right:0;text-align:right}
